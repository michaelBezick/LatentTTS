...
ATTENTION_COMMUNICATION_TYPE="${ATTENTION_COMMUNICATION_TYPE:-attention}"
BASELINE_COMMUNICATION_TYPE="${BASELINE_COMMUNICATION_TYPE:-none}"
...
export ATTENTION_PRM_ID
export BASELINE_PRM_ID
export ATTENTION_COMMUNICATION_TYPE
export BASELINE_COMMUNICATION_TYPE
export DATA_PATH
