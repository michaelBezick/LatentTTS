...
MERGE_SELECTION_MODE="${MERGE_SELECTION_MODE:-decoded_rerank}"
MERGE_DECODE_BATCH_SIZE="${MERGE_DECODE_BATCH_SIZE:-64}"
...
export MERGE_SELECTION_MODE
export MERGE_DECODE_BATCH_SIZE
